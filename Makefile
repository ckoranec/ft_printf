...
libft/ft_intlen.c  libft/ft_longint.c ft_printf.c print.c tools.c parse.c percision.c
...
ft_intlen.o  ft_printf.o ft_longint.o ft_printf.o print.o parse.o percision.o
